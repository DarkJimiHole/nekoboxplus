...
import moe.matsuri.nb4a.po0.Po0Settings
...
object DataStore : OnPreferenceDataStoreChangeListener {
    ...
    var po0WhitelistEnabled by configurationStore.boolean(Po0Settings.ENABLED)
    var po0WhitelistStatus by configurationStore.string(Po0Settings.STATUS) { "" }
