...
import moe.matsuri.nb4a.po0.Po0Preferences
...
class SettingsPreferenceFragment : PreferenceFragmentCompat() {
    ...
    private lateinit var po0Preferences: Po0Preferences
    private var po0StatusJob: Job? = null
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        addPreferencesFromResource(R.xml.po0_preferences)
        po0Preferences = Po0Preferences(this)
    ...
    override fun onResume() {
        super.onResume()
        po0StatusJob = lifecycleScope.launch {
            while (isActive) {
                po0Preferences.renderStatus()
                delay(2000)
            }
        }
